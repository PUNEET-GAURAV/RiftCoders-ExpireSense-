...
class InventoryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Convert Iterable to List to allow sorting
    final activeProducts = products.where((p) => !p.isConsumed).toList();
    
    // Sort: Expiring soonest first
    activeProducts.sort((a, b) => a.expiryDate.compareTo(b.expiryDate));
          ...
          ? Center(
              child: Column(
                ...
                children: [
                   ...
                   Text("NO ITEMS", style: GoogleFonts.orbitron(fontSize: 18, color: Colors.white54, letterSpacing: 2, fontWeight: FontWeight.w600)),
